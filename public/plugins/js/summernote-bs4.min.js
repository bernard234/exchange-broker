        ...
        3: function(t, e, n) {
            ...
            var ft = {
                ...
                isVisiblePoint: function(t) {
                    if (I(t.node) || !ot(t.node) || K(t.node))
                        return !0;
            ...
            var Dt = function() {
                ...
                (n = [{
                    ...
                    key: "setLastRange",
                    value: function(t) {
                        t ? this.lastRange = t : (this.lastRange = kt.create(this.editable),
                        0 === i()(this.lastRange.sc).closest(".note-editable").length && (this.lastRange = kt.createFromBodyElement(this.editable)))
                    }
                }, {
                    key: "getLastRange",
                    value: function() {
                    ...
                    value: function(t, e) {
                        ...
                        i.a.Deferred((function(t) {
                            ...
                            o.setLastRange(kt.createFromNodeAfter(t[0]).select()),
                            o.afterCommand()
                        }
                        )).fail((function(t) {
                    ...
                    value: function() {
                        var t = this.getLastRange();
                        return t.isOnAnchor() && (t = kt.createFromNode(ft.ancestor(t.sc, ft.isAnchor))),
                        t.toString()
                    }
                }, {
                    key: "onFormatBlock",
                    ...
                    value: function(t, e) {
                        ...
                        if ("" !== n) {
                            ...
                            n.isCollapsed()) {
                                ...
                                kt.createFromNodeAfter(r.firstChild).select(),
                                this.setLastRange(),
            ...
            var re = function() {
                ...
                (n = [{
                    ...
                    value: function(t) {
                        ...
                        return this.options.shortcuts && e ? (v.isMac && (e = e.replace("CMD", "âŒ˜").replace("SHIFT", "â‡§")),
            ...
            var we = function() {
                ...
                (n = [{
                    ...
                    value: function() {
                        var t = this.options.dialogsInBody ? this.$body : this.options.container
                          , e = ['<p class="text-center">', '<a href="http://summernote.org/" target="_blank">Summernote 0.8.16</a> Â· ', '<a href="https://github.com/summernote/summernote" target="_blank">Project</a> Â· ', '<a href="https://github.com/summernote/summernote/issues" target="_blank">Issues</a>', "</p>"].join("");
                        this.$dialog = this.ui.dialog({
                    ...
                    value: function() {
                        ...
                        if (t.length) {
                            ...
                            "next" === this.options.hintSelect) {
                                ...
                                kt.createFromNodeAfter(e).select();
                            this.lastWordRange = null,
                            this.hide(),
                            this.context.invoke("editor.focus")
                        }
